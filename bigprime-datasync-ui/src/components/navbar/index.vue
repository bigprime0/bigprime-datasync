    ...
    <ul class="right-side">
      ...
      <li class="navbar-user">
        <tiny-user-head v-if="!isEmpty(userStore.userInfo.avatarUrl)" v-model="userStore.userInfo.avatarUrl"
                        min
                        round type="image"></tiny-user-head>
        <tiny-user-head v-else v-model="userStore.userInfo.realName" background-color="#3ac295" class="head-item"
                        color="#fff" min round type="label"></tiny-user-head>
...
import {IconCheckOut, IconChevronDown} from '@opentiny/vue-icon'
