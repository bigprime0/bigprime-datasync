      ...
      <tiny-col :span="3">
        <tiny-form-item>
          <tiny-radio v-model='radioValue' :label="3">
            周期从星期
            <tiny-select v-model="cycle01" clearable>
              <tiny-option
            ...
            -
            <tiny-select v-model="cycle02" clearable>
              <tiny-option
                  v-for="(item,index) of weekList"
                  :key="index"
      ...
      <tiny-col :span="3">
        <tiny-form-item>
          <tiny-radio v-model='radioValue' :label="4">
            第
            <tiny-input v-model='average01' :max="4" :min="1" type="number"/>
            周的星期
            <tiny-select v-model="average02" clearable>
      ...
      <tiny-col :span="12">
        <tiny-form-item>
          <tiny-radio v-model='radioValue' :label="5">
            本月最后一个星期
            <tiny-select v-model="weekday" clearable>
              <tiny-option v-for="(item,index) of weekList" :key="index" :label="item.value" :value="item.key">
                {{ item.value }}
              </tiny-option>
            </tiny-select>
