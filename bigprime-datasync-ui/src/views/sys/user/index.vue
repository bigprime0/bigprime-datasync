  ...
  <div class="container-list">
    ...
    <div class="contain">
      <tiny-grid :data="tableData" :fit="true" size="medium" auto-resize border :stripe="true"
        ...
        <tiny-grid-column width="65">
          <template v-slot="data">
            <tiny-user-head v-if="!isEmpty(data.row.avatarUrl)" :model-value="data.row.avatarUrl" type="image" round min></tiny-user-head>
            <tiny-user-head v-else :model-value="getFirstChar(data.row.realName)" class="head-item" background-color="#3ac295" color="#fff" type="label" round min></tiny-user-head>
          </template>
        </tiny-grid-column>
        ...
        <tiny-grid-column :title="$t('common.operations')" width="100" align="center">
          <template v-slot="data">
            <div style="display: flex; gap: 10px; justify-content: center; align-items: center;">
              ...
              <div title="编辑">
                <tiny-icon-edit
                  @click="handleForm(data.row, 'update')"
