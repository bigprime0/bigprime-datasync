<template>
  <div class="ds-form">
    <tiny-form ref="menuFormRef" overflow-title :model="menuFormData" :rules="formRules" label-width="100px">
      <tiny-divider content-position="left" content-color="#7693f5" font-size="14px" height="20px">{{ $t('common.field.divider') }}
      </tiny-divider>
...
<!--      </tiny-row>-->
      ...
      <tiny-divider content-position="left" content-color="#7693f5" font-size="14px" height="20px">{{ $t('sys.menu.field.config') }}
      </tiny-divider>
